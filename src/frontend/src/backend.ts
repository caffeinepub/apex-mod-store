...
export class Backend implements backendInterface {
    ...
    async getAvailableModules(): Promise<Array<Module>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableModules();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProduct(): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.getProduct();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: Array<string>, arg7: bigint, arg8: string, arg9: bigint): Promise<{
        orderId: bigint;
        totalPrice: bigint;
    }> {
        if (this.processError) {
